import { ArrowRight, Brain, Mic, Volume, Sparkle } from "./Icons";
      ...
      <div className="max-w-6xl mx-auto px-6 py-20 space-y-24">
        ...
        <div className="grid lg:grid-cols-2 gap-10 items-center">
          <div>
            ...
            <p className="mt-5 text-ink-500 leading-relaxed text-[15px]">
              ...
              specifically optimized for English↔Nuer translation, ensuring cultural
          ...
          <div className="card p-6">
            ...
            <div className="rounded-lg bg-ink-100/70 px-4 py-3 text-sm text-ink-900">
              "How are you?"
            </div>

            <div className="flex items-center justify-between my-4">
              <span className="text-xs text-ink-500">Output:</span>
              <Tag accent>"Maku?" (Thok Naath)</Tag>
            </div>
        ...
        <div className="grid lg:grid-cols-2 gap-10 items-center">
          ...
          <div>
            ...
            <p className="mt-5 text-ink-500 leading-relaxed text-[15px]">
              Building the foundation of Nuer AI with a large-scale English↔Nuer parallel
              corpus containing over 1 million meticulously reviewed translation pairs.
            </p>
            <a href="#" className="mt-6 inline-flex items-center gap-1.5 text-sm font-medium text-ink-900 underline underline-offset-4 decoration-ink-300 hover:decoration-ink-900">
              View Datasets <ArrowRight />
            </a>
          </div>
        </div>

        {/* Row 3 — Speech & Reasoning */}
        <div className="grid lg:grid-cols-2 gap-10 items-center">
          <div>
            ...
            <ul className="mt-5 space-y-3 text-[15px] text-ink-700">
              <li className="flex items-start gap-2.5">
                <span className="mt-1 text-amber-500"><Sparkle /></span>
                <span><b className="text-ink-900">Chatbot:</b> A pivot-pipeline conversational prototype.</span>
              </li>
              <li className="flex items-start gap-2.5">
                <span className="mt-1 text-amber-500"><Sparkle /></span>
                <span><b className="text-ink-900">ASR &amp; TTS:</b> Automatic speech recognition and text-to-speech for Nuer, supporting learners and low-literacy speakers.</span>
              </li>
              <li className="flex items-start gap-2.5">
                <span className="mt-1 text-amber-500"><Sparkle /></span>
                <span><b className="text-ink-900">Native Reasoning:</b> Working toward a model that thinks in Nuer directly, rather than pivoting through English.</span>
              </li>
            </ul>
          </div>
